        ...
        <div className="w-full lg:w-1/2">
          <div className="flex flex-col items-center lg:items-start">
            <motion.h1
              ...
              initial="hidden"
              animate="visible"
              className="pb-16 text-6xl font-thin tracking-tight lg:mt-16 lg:text-8xl bg-gradient-to-r from-pink-600 via-slate-600 to-purple-600 bg-clip-text text-transparent"
            >
              Ayesha.
            </motion.h1>
            <motion.span
